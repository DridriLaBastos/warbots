...
1399
377
énergie totale,harvesters,soldats
NIL
NIL
0.0
10.0
...
"" ""
PENS
"soldats" 1.0 0 -5298144 true "" "plot (ifelse-value ticks > 20 [sum [mem1] of (Bases with [color = red])][0])"
"harvesters" 1.0 0 -13210332 true "" "plot (ifelse-value ticks > 20 [sum [mem0] of (Bases with [color = red])][0])"
